...
public class UsuarioController {
	...
	public String saveUser(@Valid @ModelAttribute("unUsuario") Usuario usuarioNuevo, BindingResult resultado,
			ModelMap model) {
	...
	public ModelAndView showUser(Authentication authentication) {
		...
		// GRUPO05.info("ingresando al metodo: show
		// User"+usuarioService.listarUsuarios().get(0).getApellido());
	...
	public ModelAndView ObtenerFormularioEditarUsuario(Model model, @PathVariable(name = "dni") Long dni)
			throws Exception {
